...
public class RetornandoValores {
	...
	public static void main(String[] args) {		
		...
		Integer posicaoCursoEscolhido = receberNumeroInteiroDoUsuario("O curso escolhido é o: ", scanner);
		...
		Integer posicaoFormaPagamentoEscolhida = receberNumeroInteiroDoUsuario("Sua forma de pagamento escolhida é o: ", scanner);
